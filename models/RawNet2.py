...
class Model(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        modelconfig_file = "config/Sinc_model.conf"
        with open(modelconfig_file, "r") as f_json:
        ...
        self.fc2_gru = nn.Linear(
            ...
            out_features=2, #d_args["nb_classes"],
            bias=True,
        )
    ...
    def forward(self, x, Freq_aug=None):
        ...
        output = self.sig(x) #output = self.logsoftmax(x)
...
# CM SYSTEM
#         EER             = 4.295908344 % (Equal error rate for countermeasure)
#
# TANDEM
#         min-tDCF                = 0.123971610
#
# BREAKDOWN CM SYSTEM
#         EER A07         = 2.746841873 % (Equal error rate for A07
#         EER A08         = 3.072796353 % (Equal error rate for A08
#         EER A09         = 0.139206037 % (Equal error rate for A09
#         EER A10         = 2.583864633 % (Equal error rate for A10
#         EER A11         = 1.076325165 % (Equal error rate for A11
#         EER A12         = 2.967536530 % (Equal error rate for A12
#         EER A13         = 0.342927586 % (Equal error rate for A13
#         EER A14         = 0.709626376 % (Equal error rate for A14
#         EER A15         = 2.729868767 % (Equal error rate for A15
#         EER A16         = 0.913347926 % (Equal error rate for A16
#         EER A17         = 7.262662181 % (Equal error rate for A17
#         EER A18         = 14.491378149 % (Equal error rate for A18
#         EER A19         = 1.443023955 % (Equal error rate for A19
# Exp FIN. EER: 3.780, min t-DCF: 0.11172
